...
const SingleProject = ({ name, year, align, image, link, project }) => {  //Project propu  🟡 EKLENDİ */}
  return (
    <motion.div
    ...
    >
      <div>
        ...
        <p className="text-white mt-2">{project}</p> {/* 🟡 Opsiyonel açıklama */}
        <a
          href={link}
          target="_blank" // Yeni sekmede açılmasını sağlıyoruz
          rel="noopener noreferrer" // Güvenlik amacıyla ekliyoruz
